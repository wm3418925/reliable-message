...
public class Bootstrap extends AbstractIdleService implements ServletContextListener {
	...
	protected void startUp() throws Exception {
		loadLog4jConfig();
		logger.info("===================unconsumed-message-checker START BEGIN==========================");
		...
		logger.info("===================unconsumed-message-checker START END==========================");
	}
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		logger.info("unconsumed-message-checker service started ");
		try {
			startUp();
		} catch (Exception ex) {
			ex.printStackTrace();
