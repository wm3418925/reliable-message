package wangmin.message.message_center_service.remote;
...
public class Bootstrap extends AbstractIdleService implements ServletContextListener {
	...
	protected void startUp() throws Exception {
		loadLog4jConfig();
		logger.info("===================message-center-service START BEGIN==========================");
		...
		logger.info("===================message-center-service START END==========================");
	}
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		logger.info("message-center-service service started ");
		try {
			startUp();
		} catch (Exception ex) {
			ex.printStackTrace();
